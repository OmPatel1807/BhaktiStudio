  ...
  return (
    ...
    >
      <div style={{ display: 'flex', alignItems: 'center', gap: '32px' }}>
        <Link to="/" style={{ textDecoration: 'none', color: 'var(--text-primary)', display: 'flex', alignItems: 'center' }}>
          <Logo size="medium" />
        </Link>

        {/* STRICT ROLE-BASED NAVIGATION LINKS (HIDDEN ON AUTH / LOGIN PAGES) */}
        {!isAuthPage && (
          <nav style={{ display: 'flex', gap: '16px', marginLeft: '8px' }}>
